        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table v-else class="table table-striped
                    ...
                    <tbody class="table-group-divider">
                        <tr class="table-primary" v-for="(toy,idx) in cart.filterItem()" :key="idx" style="text-align:center">
            ...
            <div class="modal-footer" style="display:flex; justify-content:space-between;">
                ...
                <div style="display:flex; justify-content:space-between;width:32%;">
                    ...
                    <button :disabled="coFlag" @click="coHandler" type="button" class="btn btn-warning" data-bs-dismiss="modal">Check Out</button>
                </div>
            </div>
        </div>
    </div>
